<?php
            try{// On se connecte à MySQL
                ...
                $bdd = new PDO('mysql:host=localhost;dbname=abonnement', 'root', 'root', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8',$pdo_options));
                
                // On récupère tout le contenu de la table inscription
                $reponse = $bdd->query('SELECT login, password FROM  connexion limit 1');
